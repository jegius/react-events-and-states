...
import chatReducer from '../store/reducer'; // это редуктор, который был импортирован из другого файла. Редукторы определяют, как будет изменяться состояние приложения в ответ на действия
